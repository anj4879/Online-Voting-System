  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_left">
      <ul class="faico clear">
        ...
        <li><a class="faicon-linkedin" href="https://www.linkedin.com/in/anjana-kumari-bb900a214/"><i class="fa fa-linkedin"></i></a></li>
    ...
    <div class="fl_right">
      <ul class="nospace inline pushright">
        <li><i class="fa fa-phone"></i> 6205368148</li>
        <li><i class="fa fa-envelope-o"></i> akc120@gmail.com </li>
      </ul>
    </div>
    <!-- ################################################################################################ -->
  </div>
  ...
  <footer id="footer" class="hoc clear"> 
    ...
    <div class="one_third first">
      ...
      <ul class="nospace linklist contact">
        <li><i class="fa fa-map-marker"></i>
          ...
          <p>
          Name        : Miss. Anjana Kumari <br>
          University  : National Institute of Science and Technology <br>
          Batch       : 2024 <br>
          Dept        : CSE <br>
          </p>
          </address>
    ...
    <div class="one_third">
      ...
      <ul class="nospace linklist contact">
        ...
        <li><i class="fa fa-phone"></i> 6205368148<br>
          6205368148</li>
    ...
    <div class="one_third">
      ...
      <ul class="nospace linklist contact">
        ...
        <li><i class="fa fa-envelope-o"></i> akc120rh@gmail.com </li>
